import re
from typing import Self, Protocol, Union
import openai
...
class ChatCompletionResponseCreator:
    def create_response_message(self, response : dict) -> ChatCompletionResponseChoicesMessage:
        message = ChatCompletionResponseChoicesMessage(
    ...
    def create_response_choice(self, response : dict) -> ChatCompletionResponseChoices:
        choices = ChatCompletionResponseChoices(
    ...
    def create_response_usage(self, response : dict) -> ChatCompletionResponseUsage:
        usage = ChatCompletionResponseUsage(
    ...
    @classmethod
    def create_response(cls, response : dict) -> ChatCompletionResponse:
        creator = cls()
...
class ChatCompletion:
    ...
    def __get_model_response(self, params):
